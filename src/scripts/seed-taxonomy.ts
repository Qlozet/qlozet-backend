...
export const SEED_CATEGORIES = [
  ...
  // ── FABRIC ────────────────────────────────────────────
  {
    ...
    product_type: 'Ankara',
    categories: ['Wax Print', 'Holland', 'Vlisco', 'Hitarget'],
    attributes: ['Premium', 'Lightweight', 'Heavy-weight', 'Printed'],
    icon: '🎨',
    sort_order: 0,
  },
  {
  ...
  },
  {
    kind: ProductKind.FABRIC,
    product_type: 'Cotton',
    categories: ['Plain Cotton', 'Printed Cotton', 'Adire'],
    attributes: ['Lightweight', 'Printed', 'Everyday'],
    icon: '🌿',
    sort_order: 3,
  },
  {
    kind: ProductKind.FABRIC,
    product_type: 'Silk',
    categories: ['Pure Silk', 'Satin', 'Charmeuse'],
    attributes: ['Premium', 'Lightweight', 'Luxury'],
    icon: '✨',
    sort_order: 4,
  },
  {
